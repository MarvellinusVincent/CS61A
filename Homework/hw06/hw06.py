...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            return f'You must add ${abs(self.balance - self.cost)} more funds.'
        elif self.balance > self.cost:
            statement =  f'Here is your {self.name} and ${abs(self.balance - self.cost)} change.'
            self.balance = 0
            self.stock -= 1
            return statement
        else:
            statement = f'Here is your {self.name}.'
            self.stock -= 1
            return statement
...
class Coin:
    ...
    def worth(self):
        ...
        if isinstance(self, Nickel):
            return Nickel.cents + max((Mint.present_year - self.year - 50),0)
        return Dime.cents + max((Mint.present_year - self.year - 50),0)
